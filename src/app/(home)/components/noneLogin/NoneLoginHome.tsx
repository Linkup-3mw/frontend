...
export default function NoneLoginHome() {
  return (
    <main className="pt-[5rem] pb-[14.6rem] max-md:pt-[4.875rem] max-md:pb-[3.75rem]">
      <section className="px-[1.25rem] box-border bg-[url(/images/home/bg_home.jpg)] bg-cover max-md:bg-[center_right_70%]">
        <ContentWrap
          className={
      ...
      <section className="mt-[5rem] max-lg:px-0 px-[1.25rem] box-border max-md:mt-0 max-md:px-0 ">
        <ContentWrap
          className="pt-[5rem] px-[2.5rem] pb-[20rem] rounded-t-[1rem] bg-blue-50 
          max-md:pt-[3.75rem] max-md:pb-[7.5rem] max-md:px-0  max-md:bg-transparent
        "
        >
