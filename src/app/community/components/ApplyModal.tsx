...
interface Props {
  ...
  setIsLoading: Dispatch<SetStateAction<boolean>>; //외부 가입하기 버튼 loading 처리
}

export default function ApplyModal({ setIsShow, setIsLoading }: Props) {
              ...
              <div className="bg-blue-50 md:px-[2.5rem] px-4 md:pb-[2.5rem] pb-4 rounded-2xl shadow-lg md:w-[62.875rem] w-[20rem] mx-auto">
                ...
                <div className="md:pt-8 pt-2">
                  ...
                  <form onSubmit={handleSubmit} className="pb-2 md:pb-4">
                    <div className="overflow-auto max-h-[calc(100vh_-_30rem)] max-md:max-h-[calc(100vh_-_21rem)]">
